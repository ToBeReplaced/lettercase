(ns org.tobereplaced.lettercase-test
  (:require (clojure (test :refer [deftest is are]))
            (org.tobereplaced (lettercase :refer [camel camel-space camel-underscore
                                                  camel-hyphen mixed mixed-space
                                                  mixed-underscore mixed-hyphen
                                                  upper upper-space upper-underscore
                                                  upper-hyphen lower lower-space
                                                  lower-underscore lower-hyphen])))
...
(deftest some-examples
  (let [src "helloWorldWhat,is-up_withYou"]
    (are [x y] (= x y)
         (camel src) "HelloWorldWhatIsUpWithYou"
         (camel-space src) "Hello World What Is Up With You"
         (camel-underscore src) "Hello_World_What_Is_Up_With_You"
         (camel-hyphen src) "Hello-World-What-Is-Up-With-You"
